...
class AskVoucherDialog(
    val activity: Activity,
    val yes: () -> Unit,
    val no: () -> Unit,
    stringRes: Int = R.string.ask_to_use_voucher,
) {

    private var dialog: AlertDialog? = null

    private var mView =
        activity.layoutInflater.inflate(R.layout.ask_voucher_dialog, null) as ViewGroup
    ...
    init {
        ...
        title.text = activity.getString(stringRes)
