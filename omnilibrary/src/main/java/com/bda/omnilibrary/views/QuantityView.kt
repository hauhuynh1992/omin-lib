...
class QuantityView : RelativeLayout, RadioCheckable {
    private lateinit var mText: SfTextView
    ...
    private fun parseAttributes(attrs: AttributeSet) {
        val a = context.obtainStyledAttributes(
            attrs,
            R.styleable.QuantityView, 0, 0
        )

        try {
            mCount = a.getColor(
                R.styleable.QuantityView_count,
                Color.RED
            )
        } finally {
            a.recycle()
    ...
    private fun inflateView() {
        ...
        inflater.inflate(R.layout.item_count_selector, this, true)
    ...
    protected fun bindView() {
        if (mCount != null) {
            ...
            shape.setSize(resources.getDimensionPixelSize(R.dimen._19sdp), resources.getDimensionPixelSize(R.dimen._19sdp))
            shape.cornerRadius = resources.getDimensionPixelSize(R.dimen._3sdp).toFloat()
            shape.setStroke(resources.getDimensionPixelSize(R.dimen._1sdp), Color.WHITE)
