...
package com.bda.omnilibrary.provider;
...
import com.bda.omnilibrary.provider.model.Movie;
...
public class VideoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.bda.omnilibrary";
    ...
    public Cursor query(
        ...
        if (mUriMatcher.match(uri) == SEARCH_SUGGEST) {
            Log.d(TAG, "Search suggestions requested." + uri.getLastPathSegment());
            return search("");
