...
class ReviewOrderPresenter(view: ReviewOrderContact.View, context: Context) :
    ReviewOrderContact.Presenter {
    private var mView: ReviewOrderContact.View = view
    ...
    private fun onRetrieveDataSuccess(model: ListOrderResponce) {
