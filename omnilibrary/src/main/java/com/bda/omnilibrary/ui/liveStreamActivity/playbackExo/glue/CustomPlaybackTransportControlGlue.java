...
public class CustomPlaybackTransportControlGlue<T extends PlayerAdapter>
    ...
    static class UpdatePlaybackStateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_UPDATE_PLAYBACK_STATE) {
                CustomPlaybackTransportControlGlue glue =
                        ((WeakReference<CustomPlaybackTransportControlGlue>) msg.obj).get();
                if (glue != null) {
    ...
    final WeakReference<CustomPlaybackBaseControlGlue> mGlueWeakReference = new WeakReference(this);
     ...
     */
    public CustomPlaybackTransportControlGlue(Context context, T impl) {
        super(context, impl);
    }
        ...
        final AbstractDetailsDescriptionPresenter detailsPresenter =
                new AbstractDetailsDescriptionPresenter() {
                    ...
                    protected void onBindDescription(ViewHolder
                        ...
                        CustomPlaybackBaseControlGlue glue = (CustomPlaybackBaseControlGlue) obj;
