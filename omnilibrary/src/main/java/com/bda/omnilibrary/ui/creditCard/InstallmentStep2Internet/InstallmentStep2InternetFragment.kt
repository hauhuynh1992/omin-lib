package com.bda.omnilibrary.ui.checkoutExistingUser.creditCard.InstallmentStep2Internet
...
import kotlinx.android.synthetic.main.fragment_installment_step2_internet.*

/**
 * A simple [Fragment] subclass.
 */
class InstallmentStep2InternetFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_installment_step2_internet, container, false)
    }

    companion object {
        @JvmStatic
        fun newInstance() =
            InstallmentStep2InternetFragment()/*.apply {
