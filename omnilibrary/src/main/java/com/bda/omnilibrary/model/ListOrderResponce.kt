...
@Parcelize
data class ListOrderResponce(
    @SerializedName("statusCode") val status: Int,
    @SerializedName("data") val data: ArrayList<Data>,
    @SerializedName("filter_orders") val filter_orders: FilterOrder

) : Parcelable {

    @Parcelize
    data class FilterOrder(
        @SerializedName("success") private val _success: ArrayList<Data>,
        @SerializedName("processing") private val _processing: ArrayList<Data>
    ) : Parcelable {
        val success
            get() = _success.takeIf { _success != null } ?: ArrayList()
        val processing
            get() = _processing.takeIf { _processing != null } ?: ArrayList()
    }
    ...
    data class Data(
        ...
        @SerializedName("order.items") val items: ArrayList<Item>,
