...
data class BrandShopModel(
    ...
    data class LayoutSection(
        ...
        @SerializedName("layout_type") private var _layout_type: Int? = 1,
        ...
        @SerializedName("brandshop_collection") private var _brandshop_collection: ArrayList<SimpleCollection>,
        ...
        val collections
            get() = _collection.takeIf { _collection != null }
                ?: ArrayList()
        val brandshop_collections
            get() = _brandshop_collection.takeIf { _brandshop_collection != null }
                ?: ArrayList()
