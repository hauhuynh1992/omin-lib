...
class RemoveProductNotMatchAdapter(
    activity: Activity,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val v = mInflater
            .inflate(R.layout.item_not_match, parent, false)
        v.isFocusable = true
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.remark.text =
            mActivity.resources.getString(R.string.not_match_location,
                Functions.getAreaString(mList[position].areas))
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val remark: SfTextView = view.findViewById(R.id.remark)
